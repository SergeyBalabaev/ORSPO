## Task099 — Секции и сегменты ELF файла 🔍 
...
Изучите вывод программы. Увеличьте размер всех массивов до 1000. Перекомпилируйте и посмотрите, как изменился размер, выводимый командой size. 
...
```
изучите из каких секций состоит программа. 

Используя команду:
```bash
readelf --segments main
```
определите, в какие сегменты отображается каждая из секций. 

В чем отличие секций от сегментов?
